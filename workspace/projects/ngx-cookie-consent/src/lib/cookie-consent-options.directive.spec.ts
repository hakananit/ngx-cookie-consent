...
describe('CookieConsentOptionsDirective', () => {
  beforeEach(() => {
  ...
  it('should create an instance', () => {
    const directive = new CookieConsentOptionsDirective();
    expect(directive).toBeTruthy();
  });
  it('should append "ngx-cookie-consent__options" class in the host element', () => {
    ...
    expect(divElement[0].classList).toContain('ngx-cookie-consent__options');
  });
});
@Component({
  template: '<div ngxCookieConsentOptions></div>'
})
